...
import { Search, MapPin, Phone, Calendar, Clock, PlusCircle, History, User } from 'lucide-react';
...
const Parties = () => {
    ...
    return (
        <div className="h-[calc(100vh-6rem)] w-full flex gap-4 overflow-hidden">

            {/* 🟦 COLUMN 1: Parties List */}
            <div className="w-1/4 min-w-[250px] bg-white border border-slate-200 rounded-xl shadow-sm flex flex-col">
